...
function applyTuningDefaults(existing, tuning, modelProfile) {
...
function deploySettings(targetDir, tuning, modelProfile) {
  ...
  applyTuningDefaults(existing, tuning, modelProfile);
